...
"""
    execute_single_measured(qws::QWSearch{<:QWModelDiscr},[ initstate,] runtime::Int)
...
"""
    execute_all(qws::QSWSearch{<:QWModelDiscr},[ initstate,] runtime::Int)
...
"""
    execute_all_measured(qws::QWSearch{<:QWModelDiscr},[ initstate,] runtime::Int)
